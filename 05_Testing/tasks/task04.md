# Лабораторная работа 4. Ручное интеграционное тестирование веб-сайта
...
* Отчет о тестировании в формате pdf разместить в каталоге Task04. Примеры оформления размещены в репозитории.
