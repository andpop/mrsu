...
На стартовой странице приложения должен выводиться список всех студентов c сортировкой по номеру группы и фамилии. Также должна быть реализована фильтрация по номеру группы, выбираемому из выпадающего списка. 	
