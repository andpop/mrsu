...
* SQL-команды для создания таблиц и заполнения их имеющимися данными поместить в файл db_init.sql. **Данный скрипт должен отрабатывать не более чем за 3 секунды!**
